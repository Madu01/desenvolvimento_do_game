...
public class SQLite : MonoBehaviour{
    ...
    void Start(){
        ...
        string criar_tabela = "CREATE TABLE IF NOT EXISTS ultimo_save (id INTEGER PRIMARY KEY AUTOINCREMENT, tela_salva INTEGER )"; //Escrevendo o comando a ser executado no BD, no caso, será criada uma tabela "ultimo_save" com as colunas "id" (com "auto incremento"!) e "tela_salva"
